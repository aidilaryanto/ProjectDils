...
async def reedme(e):
    await e.edit(
        ...
        "\n[OpenUserBot's README.md file](https://github.com/aidilaryanto/DilBot/blob/sql-extended/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "click [Here](https://github.com/aidilaryanto/DilBot) to open DilBot's repo.."
    )
