...
UPSTREAM_REPO_URL = (
    os.environ.get("UPSTREAM_REPO_URL") or "https://github.com/aidilaryanto/ProjectDils.git"
)
...
TEMP_DOWNLOAD_DIRECTORY = os.environ.get("TMP_DOWNLOAD_DIRECTORY") or "/ProjectDils/.bin"
